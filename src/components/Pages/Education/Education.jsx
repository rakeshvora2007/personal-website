                      ...
                      <div className="block">
                          ...
                          <div className="block wow fadeInUp animated" data-wow-duration="400ms" data-wow-delay="600ms">
                            ...
                            <ul className= "animated bounceInLeft">
                              ...
                              <li>Information Technology for Management of Enterprise</li>
                              <li>Information Storage Management and Disaster Recovery</li>
                              <li>Gaming Architecture and Programming</li>
                              <li>GUI and Database Management</li>
                              <li>Financial Accounting and Management of Technology Innovation</li>
                              <li>Database Technologies</li>
                              <li>Computer Graphics and Virtual Reality Systems</li>
                              <li>Data warehousing, Mining, and Business Intelligence</li>
